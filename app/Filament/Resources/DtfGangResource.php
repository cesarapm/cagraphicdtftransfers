...
class DtfGangResource extends Resource
{
    protected static ?string $model = DtfGang::class;
    ...
    {
        return [
            'index' => Pages\ListDtfGangs::route('/'),
            'create' => Pages\CreateDtfGang::route('/create'),
            'edit' => Pages\EditDtfGang::route('/{record}/edit'),
        ];
    }
}
