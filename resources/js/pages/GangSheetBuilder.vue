...
onMounted(() => {
    document.title = 'Gang Sheet Builder | CA Graphic DTF Transfers';
    ...
    updateMeta('og:title', 'Gang Sheet Builder | CA Graphic DTF Transfers', true);
...
const openCanvas = () => {
    ...
    // Navigate to canvas with the selected sheet ID
    router.push({
        name: 'GangSheetBuilderCanvas',
        params: { sheetId: selectedSize.value.id }
    });
};
                ...
                <div class="details-content">
                  ...
                  <div class="action-section">
                    ...
                    <!-- <div class="image-upload-section" v-if="selectedSize"> -->
                      ...
                      <!-- Open Canvas Button -->
                      <button @click="openCanvas" class="add-to-cart-btn">
                        Open Canvas Editor
                      </button>
                    <!-- </div> -->
                  </div>
          ...
          <table class="cart-table">
            ...
            <tbody>
              <tr v-for="item in cartItems" :key="item.id" class="cart-row">
                ...
                <td class="col-size">
                  <div class="size-info">
                    <p class="size-name">{{ item.product?.name || item.product_name }}</p>
                    <p class="size-dimensions">{{ item.product?.width || item.width }}" x {{ item.product?.height || item.height }}"</p>
                  </div>
                </td>
...
.dtf-transfers-size-hero {
  position: relative;
  height: 622px;
  background-image: url('/images/portadas/DTF_Transfers_Builder.webp');
